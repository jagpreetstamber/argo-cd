...
func NewClientApp(settings *settings.ArgoCDSettings, dexServerAddr string, dexTlsConfig *dex.DexTLSConfig, baseHRef string, cacheClient cache.CacheClient, tokenProvider workloadidentity.TokenProvider) (*ClientApp, error) {
